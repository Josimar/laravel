        ...
        <div class="card-body">
                            ...
                            @php
                                ...
                                if(old('listas') ?? false){
                                    ...
                                    if ($key || $key > -1){
                                        ...
                                        foreach ($produto->listas as $lista){
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required name="nome" id="nome" class="form-control @error('nome') is-invalid @enderror" value="{{ old('nome') ?? ($produto->nome ?? '') }}" placeholder="{{__('controle.enter_nome')}}">
                    @error('nome')
