...
class BolaoController
{
    ...
    public function __construct(BolaoInterface $model){
        ...
        $this->colunas = ['id'=>'#', 'titulo'=>trans('controle.title'),
            ...
            'rodadaatual'=>trans('controle.rodadaatual'),
            'pontosresultado'=>trans('controle.pontosresultado'),
            'pontosextra'=>trans('controle.pontosextra'),
            'pontostaxa'=>trans('controle.pontostaxa')];
    }
